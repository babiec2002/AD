...
if (((Test-Path -Path "AppxManifest.xml","Assets","CustomInstall","Fonts","GSKServer","Images","Licenses","Registry.dat","Styles","Tools","WSACodecs.dll","WSACrashUploader","WinMetadata","WsaClient","WsaProxy","WsaService","WsaSettings.exe","WsaSettings.winmd","WsaSettingsBroker","appcompatdb.json","appcompatdb_schema.json","classicAppInstaller_WSA.sccd","gfxstream_backend.dll","libEGL.dll","libGLESv2.dll","lxutil.dll","metadata.vhdx","product.img","resources.pri","system.img","system_ext.img","userdata.vhdx","vclibs.appx","vendor.img","wslcore.dll","wsldeps.dll","wsldevicehost.dll","wslhost.exe","xaml.appx") -eq $false).Count) {
